<div class="container">
    <form action="editUser" method="POST">
        <table class="table table-striped text-center" style="width: 40%; margin-left:auto; margin-right:auto;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="login_user" value="<?= htmlspecialchars($user->getLoginUser()) ?>"
                            maxlength="32">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="password" name="pass_user" value="<?= htmlspecialchars($user->getPassUser()) ?>"
                            maxlength="32">
                    </td>
                </tr>
            </tbody>
        ...
        <div class="text-center">
            <a href="dashboard3" class="btn btn-secondary mx-3 my-1">Retour</a>
